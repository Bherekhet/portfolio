  ...
  return (
    <body>
      <div className={layoutStyles.wrapper}>
        <div className={layoutStyles.topNav}>
          ...
          <div className={layoutStyles.about}>
            <h3>about me</h3>
            <p>I am a software developer who enjoys creating and improving applications. And when I am not teching I love playing soccer and ping pong.</p>
          </div>
